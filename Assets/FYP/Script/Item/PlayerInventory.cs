...
public class PlayerInventory : MonoBehaviour
{
    ...
    [SerializeField] GameObject flashlights_item;
    ...
    [SerializeField] GameObject flashlights_prefab;
    ...
    void Start()
    {
        ...
        itemSetActive.Add(itemType.flashlights, flashlights_item);
        ...
        itemInstantiate.Add(itemType.flashlights, flashlights_prefab);
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Alpha4) && inventoryList.Count > 3) //&& !animationIsPlaying)
        {
            selectedItem = 3;
            NewItemSelected();
        }

        if (Input.GetKeyDown(KeyCode.Alpha4) && inventoryList.Count > 4) //&& !animationIsPlaying)
        {
            selectedItem = 4;
            NewItemSelected();
        }
    ...
    private void NewItemSelected()
    {
        ...
        flashlights_item.SetActive(false);
